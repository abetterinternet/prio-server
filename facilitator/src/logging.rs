...
pub(crate) const BATCH_ID_EVENT_KEY: EventKey = "batch_id";
pub(crate) const BATCH_DATE_EVENT_KEY: EventKey = "batch_date";
...
pub(crate) const STORAGE_PATH_EVENT_KEY: EventKey = "path";
pub(crate) const STORAGE_KEY_EVENT_KEY: EventKey = "key";
pub(crate) const IDENTITY_EVENT_KEY: EventKey = "identity";
pub(crate) const TASK_QUEUE_ID_EVENT_KEY: EventKey = "task_queue_id";
pub(crate) const TASK_ACKNOWLEDGEMENT_ID_EVENT_KEY: EventKey = "task_ack_id";
